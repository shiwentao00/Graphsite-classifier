...
## Dataset
The dataset used in the experiment can be accessed via this [OSF repo](https://osf.io/dtuhp/). The dataset consists of 21,125 binding pockets which are grouped into 14 classes. The details of the classes are described [here](docs/data.md). There are three files needed for training:
