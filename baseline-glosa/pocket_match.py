...
def pocket_match(pocket, pocket_cf, label_pocket, label_pocket_cf):
    """call C++ GLOSA program to do pocket matching"""
    ...
    for label, cluster in enumerate(clusters):
        ...
        for pocket in cluster:
            ...
            for out in range(14):
                ...
                label_pocket_cf = label_dir + \
                    label_to_pocket[out] + '-cf.pdb'  # chemical feature file
                ...
                scores.append(pocket_match(
                    in_pocket, in_pocket_cf, label_pocket, label_pocket_cf))
